...
const Estrellas=(puntaje)=>{
    //const divisor=3000 //arreglar después
    const estrella=puntaje.puntaje

    
    if(estrella==0 ||estrella==null){//0 estrella
        return(
    ...
    else if(estrella >0 && estrella <1){//0.5
        return(
            <div>
                
            {/*<h1> {estrella}</h1>*/}
                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-star-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    else if (estrella>1 && estrella <2 ){//1.5
        return(
            <div>{/*<h1> {estrella}</h1>*/}
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-star-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.283.95l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    ...
    else if (estrella>2 && estrella<3 ){ //2.5
        return(
            <div>{/*<h1> {estrella}</h1>*/}
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-star-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.283.95l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    ...
    else if (estrella>3 && estrella <4 ){//3.5
        return(
            <div>{/*<h1> {estrella}</h1>*/}
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-star-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.283.95l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
